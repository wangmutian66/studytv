function Bmapinit(latitude_start,longitude_start,latitude_end,longitude_end){
	// 百度地图API功能
	var map = new BMap.Map("allmap");
	map.centerAndZoom(new BMap.Point(latitude_start, longitude_start), 15);
	var bounds = null;
	var linesPoints = null;
	var spoi1 = new BMap.Point(latitude_start,longitude_start);    // 起点1
	//var spoi2 = new BMap.Point(116.380967,39.953285);    // 起点2
	var epoi  = new BMap.Point(latitude_end,longitude_end);    // 终点
